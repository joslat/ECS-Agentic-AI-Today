...
public static class D02_ChatClientAgent
{
    public static async Task Execute()
    {
        ...
        await InvokeAgentAsync(agent, "What happened on this day as today which is significant on the past 200 years");
    ...
    static async Task InvokeAgentAsync(ChatCompletionAgent agent, string input)
    {
        ...
        await foreach (AgentResponseItem<Microsoft.SemanticKernel.ChatMessageContent> response in agent.InvokeAsync(message))
        {
